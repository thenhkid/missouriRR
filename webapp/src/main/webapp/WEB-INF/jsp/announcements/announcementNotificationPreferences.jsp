...
<div class="page-content">
    <div class="alert alert-block alert-success successAlert" style="display:none;">
        ...
        <p><strong><i class="ace-icon fa fa-check"></i></strong>
            You successfully updated your announcement notification settings.
        </p>
    </div>
    ...
    <form:form id="notificationPreferencesForm" modelAttribute="notificationPreferences" role="form" class="form" method="post">
        ...
        <div class="row">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        <form:checkbox path="myHierarchiesOnly" />  Receive email notifications for new and updated announcements for my counties only.
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        <form:checkbox path="allAnnouncements" />  Receive email notifications for all new and updated announcements.
                    </label>
                </div>
            </div>
        </div>              
