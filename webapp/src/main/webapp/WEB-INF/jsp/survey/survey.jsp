                                                                                                        ...
                                                                                                        <label style="padding-right:10px;">
                                                                                                            <c:choose>
                                                                                                                <c:when test="${question.allowMultipleAns == true}">
                                                                                                                    <input qnum="${qNum}" type="checkbox" <c:if test="${disabled == true}">disabled</c:if> value="${choiceDetails.id}" rel="${question.id}" rel2="surveyPageQuestions[${q.index}].questionValue" rel3="1" name="surveyPageQuestions[${q.index}].questionValue" <c:if test="${question.required == true}">class="required"</c:if> <c:choose><c:when test="${choiceDetails.choiceValue > 0 && question.questionValue.matches('[0-9]+')}"><c:if test="${fn:contains(question.questionValue, choiceDetails.choiceValue)}">checked="true"</c:if></c:when><c:otherwise><c:if test="${fn:contains(question.questionValue, choiceDetails.choiceText)}">checked="true"</c:if></c:otherwise></c:choose> /> ${choiceDetails.choiceText}
                                                                                                                </c:when>
                                                                                                                <c:otherwise>
                                                                                                                 <input qnum="${qNum}" type="radio" <c:if test="${disabled == true}">disabled</c:if> value="${choiceDetails.id}" rel="${question.id}" rel2="surveyPageQuestions[${q.index}].questionValue" rel3="1" name="surveyPageQuestions[${q.index}].questionValue" <c:if test="${question.required == true}">class="required"</c:if> <c:choose><c:when test="${choiceDetails.choiceValue > 0 && question.questionValue.matches('[0-9]+')}"><c:if test="${choiceDetails.choiceValue == question.questionValue}">checked="true"</c:if></c:when><c:otherwise><c:if test="${choiceDetails.choiceText == question.questionValue}">checked="true"</c:if></c:otherwise></c:choose> /> ${choiceDetails.choiceText}
                                                                                                                </c:otherwise>
                                                                                                            </c:choose>
                                                                                                        </label>
                                                                                                    </c:forEach>   
                                                                                                ...
                                                                                                <c:forEach items="${question.questionChoices}" var="choiceDetails">
                                                                                                    <div class="col-xs-12 col-sm-6" style="margin-bottom:3px;">
                                                                                                        <div class="pull-left col-xs-pull-0">
                                                                                                            <c:choose>
                                                                                                                <c:when test="${question.allowMultipleAns == true}">
                                                                                                                    <input qnum="${qNum}" type="checkbox" <c:if test="${disabled == true}">disabled</c:if> value="${choiceDetails.id}" rel="${question.id}" rel2="surveyPageQuestions[${q.index}].questionValue" rel3="1" name="surveyPageQuestions[${q.index}].questionValue" <c:if test="${question.required == true}">class="required"</c:if> <c:choose><c:when test="${choiceDetails.choiceValue > 0 && question.questionValue.matches('[0-9]+')}"><c:if test="${fn:contains(question.questionValue, choiceDetails.choiceValue)}">checked="true"</c:if></c:when><c:otherwise><c:if test="${fn:contains(question.questionValue, choiceDetails.choiceText)}">checked="true"</c:if></c:otherwise></c:choose> />
                                                                                                                </c:when>
                                                                                                                <c:otherwise>
                                                                                                                    <input qnum="${qNum}" type="radio" <c:if test="${disabled == true}">disabled</c:if> value="${choiceDetails.id}" rel="${question.id}" rel2="surveyPageQuestions[${q.index}].questionValue" rel3="1" name="surveyPageQuestions[${q.index}].questionValue" <c:if test="${question.required == true}">class="required"</c:if> <c:choose><c:when test="${choiceDetails.choiceValue > 0 && question.questionValue.matches('[0-9]+')}"><c:if test="${choiceDetails.choiceValue == question.questionValue}">checked="true"</c:if></c:when><c:otherwise><c:if test="${choiceDetails.choiceText == question.questionValue}">checked="true"</c:if></c:otherwise></c:choose> />
                                                                                                                </c:otherwise>
                                                                                                            </c:choose>
                                                                                                        </div>
                                                                                                        <div class="pull-left col-xs-11">
