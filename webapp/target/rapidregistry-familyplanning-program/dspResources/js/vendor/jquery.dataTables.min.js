	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" class="form-control" placeholder="Filter Results" />') :
                          sSearchStr==="" ? '<input type="text" class="form-control" placeholder="Filter Results" />' : sSearchStr+' <input type="text" class="form-control" placeholder="Filter Results" />';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select size="1" '+sName+' style="width:100px" class="form-control">';
			var i, iLen;
