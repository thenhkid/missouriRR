        ...
        <div class="modal-header">
            ...
            <form:form id="hierarchyItemdetailsform" commandName="hierarchyDetails" modelAttribute="hierarchyDetails"  method="post" role="form">
                ...
                <div class="form-container">
                    ...
                    <c:if test="${not empty hierarchyItems}">
                        <div class="form-group ${status.error ? 'has-error' : '' }">
                            <label class="control-label" for="state">${parentHierarchy}</label>
                            <form:select  path="associatedWith" class="form-control">
                                <c:forEach var="parentItem" items="${hierarchyItems}" >
                                    <option value="${parentItem.id}" <c:if test="${parentItem.id == hierarchyDetails.associatedWith}">selected</c:if>>${parentItem.name}</option>
                                </c:forEach>
                            </form:select>
                        </div>
                    </c:if>    
